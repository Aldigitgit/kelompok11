    ...
    <section className="bg-gray-50 py-16 px-6 md:px-10 lg:px-32">
      <div className="max-w-4xl mx-auto text-gray-800">
        ...
        <p className="mb-4 text-gray-700 leading-relaxed">
          Your privacy matters to us. PeriPlus collects only essential personal
          data to provide a better reading experience and secure transactions.
        </p>
        ...
        <div className="space-y-4 text-sm text-gray-600">
          ...
          <div>
            ...
            <p>
              We do not sell or share your personal data to third-party
              advertisers. All data is encrypted and stored securely.
            </p>
          </div>
        </div>
